...
<section class="home-products">
   ...
   <form action="" method="post" class="swiper-slide slide">
      ...
      <input type="hidden" name="original_price" value="<?= $fetch_product['original_price']; ?>">
      ...
      <div class="flex">
         ...
         <div class="original-price"><?=number_format($fetch_product['original_price'],0,".",",") ; ?><span>đ</span></div>
